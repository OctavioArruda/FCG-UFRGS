...
glm::mat4 Matrix_Rotate(float angle, glm::vec4 axis)
{
  ...
  return Matrix(
      // Matriz de rotação 3d em torno do eixo V - form. de Rodrigues
...
{
  glm::vec4 w = -view_vector;               /* Cálculo do vetor w */
  glm::vec4 u = crossproduct(up_vector, w); /* Cálculo do vetor u */
